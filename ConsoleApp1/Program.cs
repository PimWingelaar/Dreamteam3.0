...
namespace BoekenWinkel
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var testtijdschrift = new Tijdschrift("donald_duck", "walt disney", Enum_taal.Nederlands, 140, 4.99, testAfmeting, 16-02-2018 , 20-02-2018, 54987618, 200);
            ...
            String test2 = Boekenwinkel.ToonAlleBoeken();
            Console.WriteLine(test);
            Console.ReadLine();
        }
    }
